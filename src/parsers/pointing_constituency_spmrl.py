...
from src.models import PointingConstituencySPMRLModel
...
class PointingConstituencySPMRLParser(Parser):

    NAME = 'pointing-constituency-spmrl'
    MODEL = PointingConstituencySPMRLModel
