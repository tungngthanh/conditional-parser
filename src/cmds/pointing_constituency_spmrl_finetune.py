...
from src import PointingConstituencySPMRLParserFinetune
from src.cmds.cmd import parse


def main():
    parser = argparse.ArgumentParser(description='Create Constituency Parser.')
    parser.set_defaults(Parser=PointingConstituencySPMRLParserFinetune)
    ...
    subparser.add_argument('--data_path', default='',
    ...
    subparser.add_argument('--learning_rate_schedule', default='',
                           help='learning rate schedule in training')
    subparser.add_argument('--binarize_direction', default='left',
                           help='binarize direction in procees data')
    subparser.add_argument('--dummy_label_manipulating', default='parent',
                           help='binarize direction in procees data')
    subparser.add_argument('--bert_requires_grad', default='True',
                           help='binarize direction in procees data')
