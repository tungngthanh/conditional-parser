...
from src import PointingConstituencySPMRLParser
from src.cmds.cmd import parse


def main():
    parser = argparse.ArgumentParser(description='Create Constituency Parser.')
    parser.set_defaults(Parser=PointingConstituencySPMRLParser)
    ...
    subparser.add_argument('--dummy_label_manipulating', default='parent',
                           help='binarize direction in procees data')
    subparser.add_argument('--bert_requires_grad', default='False',
                           help='binarize direction in procees data')
